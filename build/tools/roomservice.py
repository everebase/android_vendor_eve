...
DEBUG = False
default_manifest = ".repo/manifests/eve_default.xml"
custom_local_manifest = ".repo/local_manifests/eve_manifest.xml"
custom_default_revision = "8.1"
custom_dependencies = "eve.dependencies"
org_manifest = "Eve-OS-Devices"  # leave empty if org is provided in manifest
org_display = "Eve-OS-Devices"  # needed for displaying
