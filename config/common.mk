...
bootanimation_sizes := $(subst .zip,, $(shell ls vendor/eve/prebuilt/common/bootanimation))
...
PRODUCT_COPY_FILES += \
    vendor/eve/prebuilt/common/bootanimation/halfres/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
else
PRODUCT_COPY_FILES += \
    vendor/eve/prebuilt/common/bootanimation/$(TARGET_BOOTANIMATION_NAME).zip:system/media/bootanimation.zip
endif
endif
